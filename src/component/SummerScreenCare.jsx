...
const SummerScreenCare = () => {
  return (
    <div className="my-7 p-3">
        ...
        <div className="main mt-4 grid grid-cols-1 md:grid-cols-4 gap-4">

          <div className="hover:bg-gray-200 hover:shadow-xl animate__fadeIn duration-200 border border-orange-500 p-4 rounded-md shadow-md  col-span-4 md:col-span-2 space-y-2 bg-orange-100">
           ...
           <div className="hover:bg-gray-200 hover:shadow-xl animate__fadeIn duration-200 border border-orange-500 p-4 rounded-md col-span-2 space-y-2 col-span-4 md:col-span-2 bg-orange-100">
           ...
           <div className="hover:bg-gray-200 hover:shadow-xl animate__fadeIn duration-200 border border-orange-500 p-4 rounded-md col-span-4 space-y-2 col-span-4 md:col-span-4 bg-orange-100">
